...
export default function Login() {
  ...
  return (
    <View style={styles.container}>
      ...
      <TextInput style={styles.input} placeholder="Логин" value={login} onChangeText={setLogin} placeholderTextColor={colors.text} />
      <TextInput style={styles.input} placeholder="Пароль" value={password} onChangeText={setPassword} secureTextEntry placeholderTextColor={colors.text} />
...
const styles = StyleSheet.create({
  ...
  input: { backgroundColor: colors.surface, color: '#FFF', padding: spacing.m, borderRadius: 12, marginBottom: spacing.m, borderWidth: 1, borderColor: colors.primaryLight },
